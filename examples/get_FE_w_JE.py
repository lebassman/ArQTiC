...
param_free_ham = arqtic.Ising_Hamiltonian(2, Jz, [mu_x, 0, 0]) #parameter-free Hamiltonian
...
#create prog_qmetts
prog_qmetts = arqtic.Program(N)
ham0 = arqtic.Ising_Hamiltonian(N, Jz, [0,0,0])
...
bitstring = arqtic.random_bitstring(N)
